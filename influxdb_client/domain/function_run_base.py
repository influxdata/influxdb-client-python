...
class FunctionRunBase(object):
    ...
    def __init__(self, id=None, status=None, error=None, logs=None, response=None, started_at=None):  # noqa: E501,D401,D403
    ...
    @property
    def response(self):
        """Get the response of this FunctionRunBase.

        :return: The response of this FunctionRunBase.
    ...
    def response(self, response):
        """Set the response of this FunctionRunBase.

        :param response: The response of this FunctionRunBase.
