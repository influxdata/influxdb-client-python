...
class GzipSupportTest(BaseTest):
    ...
    def test_gzip_disabled(self):
        ...
        self.assertEqual("utf-8", _requests[1].headers['Content-Encoding'])
    ...
    def test_write_query_gzip(self):
        ...
        self.client = InfluxDBClient("http://localhost:9999/api/v2", token="my-token-123", org="my-org", debug=False,
                                     enable_gzip=True)
