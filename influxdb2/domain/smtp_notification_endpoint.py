...
class SMTPNotificationEndpoint(NotificationEndpointBase):
    ...
    def __init__(self, name=None, id=None, org_id=None, user_id=None, created_at=None, updated_at=None, description=None, status='active', labels=None):  # noqa: E501
        """SMTPNotificationEndpoint - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SMTPNotificationEndpoint.  # noqa: E501


        :return: The name of this SMTPNotificationEndpoint.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SMTPNotificationEndpoint.


        :param name: The name of this SMTPNotificationEndpoint.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SMTPNotificationEndpoint):
            return False
